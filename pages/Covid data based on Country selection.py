...
df=pd.read_csv("https://github.com/lre16/Laraezzeddine/blob/master/pages/covid.csv")

df1=pd.read_csv("https://github.com/lre16/Laraezzeddine/blob/master/pages/covid_grouped.csv")
